...
export default function TimelineDemo() {
      ...
      content: (
        <div key="1">
          ...
          <div className="grid grid-cols-2 gap-4">
            <img
              src="/screenshots/manageProj.png"
  ...
  return (
    <div className="relative w-full overflow-clip" id="features">
      <Timeline data={data} />
    </div>
  );
}
